import type { A_Const, FuncCall, List, String, SubLink } from '../ast-types.js';
import { functionList } from "@gntrees/sql-builder/pg/functions";
...
const specialNodeValues: Record<string, (node: any) => FunctionListType[] | FunctionListType[][]> = {
    ...
    FuncCall: (rawNode: any): FunctionListType[] => {
        ...
        const availableFuncName = Object.values(functionList).flat().find(f => f=== toCamelCase(funcName));
