 ...
 */
function extractPropertyType(propDef: string): string[] {
 ...
 */
export function toJsonString(result: AstTypesResult, pretty = true): string {
 ...
 */
export function extractAstTypesAsJson(filePath?: string): string {
