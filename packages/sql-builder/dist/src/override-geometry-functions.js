...
class GeometryFunctionBuilder extends override_enum_functions_1.EnumFunctionBuilder {
    ...
    point(x, y) {
        return this.pushFunction("POINT", x === undefined ? undefined : this.toLiteral(x), y === undefined ? undefined : this.toLiteral(y));
    }
    polygon(countOrValue, circle) {
        return this.pushFunction("POLYGON", countOrValue === undefined ? undefined : this.toLiteral(countOrValue), circle);
    }
}
