...
class SequenceFunctionBuilder extends override_xml_functions_1.XMLFunctionBuilder {
    ...
    setval(sequence, value, isCalled) {
        return this.pushFunction("SETVAL", sequence === undefined ? undefined : this.toLiteral(sequence), value === undefined ? undefined : this.toLiteralValue(value), isCalled === undefined ? undefined : this.toLiteralValue(isCalled));
    }
    currval(sequence) {
