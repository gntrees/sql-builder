...
class DateTimeFunctionBuilder extends base_query_builder_1.BaseQueryBuilder {
    ...
    dateTrunc(unit, source) {
        return this.pushFunction("DATE_TRUNC", unit === undefined ? undefined : this.toLiteral(unit), source);
    }
    datePart(field, source) {
        return this.pushFunction("DATE_PART", field === undefined ? undefined : this.toLiteral(field), source);
    }
    ...
    toChar(value, format) {
        return this.pushFunction("TO_CHAR", value, format === undefined ? undefined : this.toLiteral(format));
    }
    toDate(value, format) {
        return this.pushFunction("TO_DATE", value, format === undefined ? undefined : this.toLiteral(format));
    }
    toNumber(value, format) {
        return this.pushFunction("TO_NUMBER", value, format === undefined ? undefined : this.toLiteral(format));
    }
    toTimestamp(value, format) {
        return this.pushFunction("TO_TIMESTAMP", value, format === undefined ? undefined : this.toLiteral(format));
    }
    timezone(zone, source) {
        return this.pushFunction("TIMEZONE", zone === undefined ? undefined : this.toLiteral(zone), source);
    }
    ...
    makeDate(year, month, day) {
        return this.pushFunction("MAKE_DATE", year === undefined ? undefined : this.toLiteral(year), month === undefined ? undefined : this.toLiteral(month), day === undefined ? undefined : this.toLiteral(day));
    }
    makeInterval(years, months, weeks, days, hours, mins, secs) {
        return this.pushFunction("MAKE_INTERVAL", years === undefined ? undefined : this.toLiteral(years), months === undefined ? undefined : this.toLiteral(months), weeks === undefined ? undefined : this.toLiteral(weeks), days === undefined ? undefined : this.toLiteral(days), hours === undefined ? undefined : this.toLiteral(hours), mins === undefined ? undefined : this.toLiteral(mins), secs === undefined ? undefined : this.toLiteral(secs));
    }
    makeTime(hours, minutes, seconds) {
        return this.pushFunction("MAKE_TIME", hours === undefined ? undefined : this.toLiteral(hours), minutes === undefined ? undefined : this.toLiteral(minutes), seconds === undefined ? undefined : this.toLiteral(seconds));
    }
    makeTimestamp(year, month, day, hours, minutes, seconds) {
        return this.pushFunction("MAKE_TIMESTAMP", year === undefined ? undefined : this.toLiteral(year), month === undefined ? undefined : this.toLiteral(month), day === undefined ? undefined : this.toLiteral(day), hours === undefined ? undefined : this.toLiteral(hours), minutes === undefined ? undefined : this.toLiteral(minutes), seconds === undefined ? undefined : this.toLiteral(seconds));
    }
    ...
    pgSleep(seconds) {
        return this.pushFunction("PG_SLEEP", seconds === undefined ? undefined : this.toLiteral(seconds));
    }
    pgSleepFor(interval) {
        return this.pushFunction("PG_SLEEP_FOR", interval === undefined ? undefined : this.toLiteral(interval));
    }
    ...
    currentTime(precision) {
        ...
        return this.pushFunction("CURRENT_TIME", precision === undefined ? undefined : this.toLiteral(precision));
    }
    currentTimestamp(precision) {
        if (precision === undefined || precision === null) {
            return super.currentTimestamp();
        }
        return this.pushFunction("CURRENT_TIMESTAMP", precision === undefined ? undefined : this.toLiteral(precision));
    }
    localtime(precision) {
        if (precision === undefined || precision === null) {
            return super.localtime();
        }
        return this.pushFunction("LOCALTIME", precision === undefined ? undefined : this.toLiteral(precision));
    }
    localtimestamp(precision) {
        if (precision === undefined || precision === null) {
            return super.localtimestamp();
        }
        return this.pushFunction("LOCALTIMESTAMP", precision === undefined ? undefined : this.toLiteral(precision));
    }
    isfinite(value) {
