...
class JSONFunctionBuilder extends override_network_functions_1.NetworkFunctionBuilder {
    ...
    arrayToJson(array, prettyPrint) {
        return this.pushFunction("ARRAY_TO_JSON", array, prettyPrint === undefined ? undefined : this.toLiteralValue(prettyPrint));
    }
    /**
    ...
    rowToJson(row, prettyPrint) {
        return this.pushFunction("ROW_TO_JSON", row, prettyPrint === undefined ? undefined : this.toLiteralValue(prettyPrint));
    }
    /**
    ...
    jsonBuildArray(...values) {
        ...
        return this.pushFunction("JSON_BUILD_ARRAY", ...filtered.map(v => this.toLiteralValue(v)));
    }
    jsonbBuildArray(...values) {
        const filtered = values.filter(v => v !== undefined && v !== null);
        return this.pushFunction("JSONB_BUILD_ARRAY", ...filtered.map(v => this.toLiteralValue(v)));
    }
    /**
    ...
    jsonBuildObject(...keyValuePairs) {
        ...
        return this.pushFunction("JSON_BUILD_OBJECT", ...filtered.map(v => this.toLiteralValue(v)));
    }
    jsonbBuildObject(...keyValuePairs) {
        const filtered = keyValuePairs.filter(v => v !== undefined && v !== null);
        return this.pushFunction("JSONB_BUILD_OBJECT", ...filtered.map(v => this.toLiteralValue(v)));
    }
    /**
    ...
    jsonExtractPath(fromJson, ...pathElems) {
        ...
        return this.pushFunction("JSON_EXTRACT_PATH", fromJson, ...filtered.map(p => this.toLiteralValue(p)));
    }
    jsonbExtractPath(fromJsonb, ...pathElems) {
        const filtered = pathElems.filter(p => p !== undefined && p !== null);
        return this.pushFunction("JSONB_EXTRACT_PATH", fromJsonb, ...filtered.map(p => this.toLiteralValue(p)));
    }
    /**
    ...
    jsonExtractPathText(fromJson, ...pathElems) {
        const filtered = pathElems.filter(p => p !== undefined && p !== null);
        return this.pushFunction("JSON_EXTRACT_PATH_TEXT", fromJson, ...filtered.map(p => this.toLiteralValue(p)));
    }
    jsonbExtractPathText(fromJsonb, ...pathElems) {
        const filtered = pathElems.filter(p => p !== undefined && p !== null);
        return this.pushFunction("JSONB_EXTRACT_PATH_TEXT", fromJsonb, ...filtered.map(p => this.toLiteralValue(p)));
    }
    /**
    ...
    jsonbSet(target, path, newValue, createIfMissing) {
        return this.pushFunction("JSONB_SET", target, path, newValue, createIfMissing === undefined ? undefined : this.toLiteralValue(createIfMissing));
    }
    /**
    ...
    jsonbSetLax(target, path, newValue, createIfMissing, nullValueTreatment) {
        return this.pushFunction("JSONB_SET_LAX", target, path, newValue, createIfMissing === undefined ? undefined : this.toLiteralValue(createIfMissing), nullValueTreatment === undefined ? undefined : this.toLiteralValue(nullValueTreatment));
    }
    /**
    ...
    jsonbInsert(target, path, newValue, insertAfter) {
        return this.pushFunction("JSONB_INSERT", target, path, newValue, insertAfter === undefined ? undefined : this.toLiteralValue(insertAfter));
    }
    /**
    ...
    jsonStripNulls(target, stripInArrays) {
        return this.pushFunction("JSON_STRIP_NULLS", target, stripInArrays === undefined ? undefined : this.toLiteralValue(stripInArrays));
    }
    jsonbStripNulls(target, stripInArrays) {
        return this.pushFunction("JSONB_STRIP_NULLS", target, stripInArrays === undefined ? undefined : this.toLiteralValue(stripInArrays));
    }
    /**
    ...
    jsonbPathExists(target, path, vars, silent) {
        return this.pushFunction("JSONB_PATH_EXISTS", target, path === undefined ? undefined : this.toLiteralValue(path), vars === undefined ? undefined : this.toLiteralValue(vars), silent === undefined ? undefined : this.toLiteralValue(silent));
    }
    jsonbPathExistsTz(target, path, vars, silent) {
        return this.pushFunction("JSONB_PATH_EXISTS_TZ", target, path === undefined ? undefined : this.toLiteralValue(path), vars === undefined ? undefined : this.toLiteralValue(vars), silent === undefined ? undefined : this.toLiteralValue(silent));
    }
    /**
    ...
    jsonbPathMatch(target, path, vars, silent) {
        return this.pushFunction("JSONB_PATH_MATCH", target, path === undefined ? undefined : this.toLiteralValue(path), vars === undefined ? undefined : this.toLiteralValue(vars), silent === undefined ? undefined : this.toLiteralValue(silent));
    }
    jsonbPathMatchTz(target, path, vars, silent) {
        return this.pushFunction("JSONB_PATH_MATCH_TZ", target, path === undefined ? undefined : this.toLiteralValue(path), vars === undefined ? undefined : this.toLiteralValue(vars), silent === undefined ? undefined : this.toLiteralValue(silent));
    }
    /**
    ...
    jsonbPathQuery(target, path, vars, silent) {
        return this.pushFunction("JSONB_PATH_QUERY", target, path === undefined ? undefined : this.toLiteralValue(path), vars === undefined ? undefined : this.toLiteralValue(vars), silent === undefined ? undefined : this.toLiteralValue(silent));
    }
    jsonbPathQueryTz(target, path, vars, silent) {
        return this.pushFunction("JSONB_PATH_QUERY_TZ", target, path === undefined ? undefined : this.toLiteralValue(path), vars === undefined ? undefined : this.toLiteralValue(vars), silent === undefined ? undefined : this.toLiteralValue(silent));
    }
    /**
    ...
    jsonbPathQueryArray(target, path, vars, silent) {
        return this.pushFunction("JSONB_PATH_QUERY_ARRAY", target, path === undefined ? undefined : this.toLiteralValue(path), vars === undefined ? undefined : this.toLiteralValue(vars), silent === undefined ? undefined : this.toLiteralValue(silent));
    }
    jsonbPathQueryArrayTz(target, path, vars, silent) {
        return this.pushFunction("JSONB_PATH_QUERY_ARRAY_TZ", target, path === undefined ? undefined : this.toLiteralValue(path), vars === undefined ? undefined : this.toLiteralValue(vars), silent === undefined ? undefined : this.toLiteralValue(silent));
    }
    /**
    ...
    jsonbPathQueryFirst(target, path, vars, silent) {
        return this.pushFunction("JSONB_PATH_QUERY_FIRST", target, path === undefined ? undefined : this.toLiteralValue(path), vars === undefined ? undefined : this.toLiteralValue(vars), silent === undefined ? undefined : this.toLiteralValue(silent));
    }
    jsonbPathQueryFirstTz(target, path, vars, silent) {
        return this.pushFunction("JSONB_PATH_QUERY_FIRST_TZ", target, path === undefined ? undefined : this.toLiteralValue(path), vars === undefined ? undefined : this.toLiteralValue(vars), silent === undefined ? undefined : this.toLiteralValue(silent));
    }
    /**
