...
class EnumFunctionBuilder extends override_set_returning_functions_1.SetReturningFunctionBuilder {
    ...
    enumFirst(value) {
        return this.pushFunction("ENUM_FIRST", value === undefined ? undefined : this.toLiteral(value));
    }
    enumLast(value) {
        return this.pushFunction("ENUM_LAST", value === undefined ? undefined : this.toLiteral(value));
    }
    enumRange(start, end) {
        return this.pushFunction("ENUM_RANGE", start === undefined ? undefined : this.toLiteral(start), end === undefined ? undefined : this.toLiteral(end));
    }
}
