...
class QueryInstance {
    ...
    between(...args) {
        return (new query_builder_1.QueryBuilder(this)).between(...args);
    }
    betweenSymmetric(...args) {
        return (new query_builder_1.QueryBuilder(this)).betweenSymmetric(...args);
    }
    bigint() {
    ...
    collationFor(...args) {
        return (new query_builder_1.QueryBuilder(this)).collationFor(...args);
    }
    collationName() {
    ...
    commitPreparedTransaction(...args) {
        return (new query_builder_1.QueryBuilder(this)).commitPreparedTransaction(...args);
    }
    committed() {
    ...
    currentDate(...args) {
        return (new query_builder_1.QueryBuilder(this)).currentDate(...args);
    }
    ...
    currentSchema(...args) {
        return (new query_builder_1.QueryBuilder(this)).currentSchema(...args);
    }
    currentSchemas(...args) {
    ...
    doNothing(...args) {
        return (new query_builder_1.QueryBuilder(this)).doNothing(...args);
    }
    double() {
        return (new query_builder_1.QueryBuilder(this)).double();
    }
    doUpdate(...args) {
        return (new query_builder_1.QueryBuilder(this)).doUpdate(...args);
    }
    drop() {
    ...
    family(...args) {
        return (new query_builder_1.QueryBuilder(this)).family(...args);
    }
    fetch(...args) {
    ...
    groupByDistinct(...args) {
        return (new query_builder_1.QueryBuilder(this)).groupByDistinct(...args);
    }
    grouping(...args) {
    ...
    hasForeignDataWrapperPrivilege(...args) {
        return (new query_builder_1.QueryBuilder(this)).hasForeignDataWrapperPrivilege(...args);
    }
    ...
    into(...args) {
        return (new query_builder_1.QueryBuilder(this)).into(...args);
    }
    invoker() {
    ...
    join(...args) {
        return (new query_builder_1.QueryBuilder(this)).join(...args);
    }
    json() {
    ...
    jsonArray(...args) {
        return (new query_builder_1.QueryBuilder(this)).jsonArray(...args);
    }
    jsonArrayagg(...args) {
    ...
    jsonbObject(...args) {
        return (new query_builder_1.QueryBuilder(this)).jsonbObject(...args);
    }
    jsonbObjectAgg(...args) {
    ...
    jsonExists(...args) {
        return (new query_builder_1.QueryBuilder(this)).jsonExists(...args);
    }
    ...
    jsonObject(...args) {
        return (new query_builder_1.QueryBuilder(this)).jsonObject(...args);
    }
    jsonObjectagg(...args) {
    ...
    jsonQuery(...args) {
        return (new query_builder_1.QueryBuilder(this)).jsonQuery(...args);
    }
    jsonScalar(...args) {
        return (new query_builder_1.QueryBuilder(this)).jsonScalar(...args);
    }
    jsonSerialize(...args) {
        return (new query_builder_1.QueryBuilder(this)).jsonSerialize(...args);
    }
    jsonStripNulls(...args) {
    ...
    jsonValue(...args) {
        return (new query_builder_1.QueryBuilder(this)).jsonValue(...args);
    }
    justifyDays(...args) {
    ...
    naturalCrossJoin(...args) {
        return (new query_builder_1.QueryBuilder(this)).naturalCrossJoin(...args);
    }
    naturalFullJoin(...args) {
        return (new query_builder_1.QueryBuilder(this)).naturalFullJoin(...args);
    }
    naturalInnerJoin(...args) {
        return (new query_builder_1.QueryBuilder(this)).naturalInnerJoin(...args);
    }
    naturalJoin(...args) {
        return (new query_builder_1.QueryBuilder(this)).naturalJoin(...args);
    }
    naturalLeftJoin(...args) {
        return (new query_builder_1.QueryBuilder(this)).naturalLeftJoin(...args);
    }
    naturalRightJoin(...args) {
        return (new query_builder_1.QueryBuilder(this)).naturalRightJoin(...args);
    }
    nchar() {
    ...
    not(...args) {
        return (new query_builder_1.QueryBuilder(this)).not(...args);
    }
    notBetween(...args) {
        return (new query_builder_1.QueryBuilder(this)).notBetween(...args);
    }
    notBetweenSymmetric(...args) {
        return (new query_builder_1.QueryBuilder(this)).notBetweenSymmetric(...args);
    }
    notEq(...args) {
    ...
    nullsFirst(...args) {
        return (new query_builder_1.QueryBuilder(this)).nullsFirst(...args);
    }
    nullsLast(...args) {
        return (new query_builder_1.QueryBuilder(this)).nullsLast(...args);
    }
    number() {
    ...
    on(...args) {
        return (new query_builder_1.QueryBuilder(this)).on(...args);
    }
    onConflict(...args) {
        return (new query_builder_1.QueryBuilder(this)).onConflict(...args);
    }
    ...
    onConstraint(...args) {
        return (new query_builder_1.QueryBuilder(this)).onConstraint(...args);
    }
    one() {
    ...
    over(...args) {
        return (new query_builder_1.QueryBuilder(this)).over(...args);
    }
    overflow() {
    ...
    partitionBy(...args) {
        return (new query_builder_1.QueryBuilder(this)).partitionBy(...args);
    }
    pascal() {
    ...
    pgClearAttributeStats(...args) {
        return (new query_builder_1.QueryBuilder(this)).pgClearAttributeStats(...args);
    }
    pgClearRelationStats(...args) {
        return (new query_builder_1.QueryBuilder(this)).pgClearRelationStats(...args);
    }
    ...
    pgGetPartitionConstraintdef(...args) {
        return (new query_builder_1.QueryBuilder(this)).pgGetPartitionConstraintdef(...args);
    }
    ...
    pgRestoreAttributeStats(...args) {
        return (new query_builder_1.QueryBuilder(this)).pgRestoreAttributeStats(...args);
    }
    pgRestoreRelationStats(...args) {
        return (new query_builder_1.QueryBuilder(this)).pgRestoreRelationStats(...args);
    }
    ...
    prepareTransaction(...args) {
        return (new query_builder_1.QueryBuilder(this)).prepareTransaction(...args);
    }
    preserve() {
    ...
    releaseTransaction(...args) {
        return (new query_builder_1.QueryBuilder(this)).releaseTransaction(...args);
    }
    rename() {
    ...
    rollbackPreparedTransaction(...args) {
        return (new query_builder_1.QueryBuilder(this)).rollbackPreparedTransaction(...args);
    }
    rollbackToSavepointTransaction(...args) {
        return (new query_builder_1.QueryBuilder(this)).rollbackToSavepointTransaction(...args);
    }
    ...
    schemaCase(key, queryBuilder) {
        return (new query_builder_1.QueryBuilder(this)).schemaCase(key, queryBuilder);
    }
    schemaName() {
        return (new query_builder_1.QueryBuilder(this)).schemaName();
    }
    schemaParam(key) {
        return (new query_builder_1.QueryBuilder(this)).schemaParam(key);
    }
    schemas() {
    ...
    startTransaction(...args) {
        return (new query_builder_1.QueryBuilder(this)).startTransaction(...args);
    }
    state() {
    ...
    toText(...args) {
        return (new query_builder_1.QueryBuilder(this)).toText(...args);
    }
    toTimestamp(...args) {
    ...
    version(...args) {
        return (new query_builder_1.QueryBuilder(this)).version(...args);
    }
    versioning() {
    ...
    window(...args) {
        return (new query_builder_1.QueryBuilder(this)).window(...args);
    }
    with(...args) {
    ...
    withTies(...args) {
        return (new query_builder_1.QueryBuilder(this)).withTies(...args);
    }
    work() {
    ...
    xmlserialize(...args) {
        return (new query_builder_1.QueryBuilder(this)).xmlserialize(...args);
    }
    xmltable() {
        return (new query_builder_1.QueryBuilder(this)).xmltable();
    }
    xmltext(...args) {
        return (new query_builder_1.QueryBuilder(this)).xmltext(...args);
    }
    xmlvalidate() {
